...
export const EvervaultCard = ({
  ...
  return (
    <div
      className={cn(
        "p-0.5 bg-transparent flex items-center justify-center w-full h-auto relative",
        className
      )}>
      <div
        onMouseMove={onMouseMove}
        className="group/card rounded-3xl w-full relative overflow-hidden bg-transparent flex items-center justify-center min-h-0 h-full cursor-pointer">
        ...
        <div className="relative z-10 flex items-center justify-center w-full">
          {text ? (
            ...
            <div className="w-full [&_*]:pointer-events-auto">{children}</div>
          )}
        </div>
      </div>
    </div>
...
export function CardPattern({
  ...
  return (
    <div className="pointer-events-none">
      <div
        className="absolute inset-0 rounded-3xl [mask-image:linear-gradient(white,transparent)] group-hover/card:opacity-50"></div>
      <motion.div
